...
CREATE TABLE EATS_MENU AS SELECT * FROM MENU M; -- CTRL + ENTER
...
COMMIT; -- INSERT UPDATE DELETE 추가 수정 한 기록 저장하기 
...
--- 트랜잭션 시퀀스 -> ORACLE PRIMARY KEY는 자동으로 번호를 측정해주는 동작을 설정 
...
---- 메뉴가격 : 5500원 
INSERT INTO EATS_MENU (MENU_ID,CAFE_ID,MENU_NAME,DECRIPTION,PRICE)
